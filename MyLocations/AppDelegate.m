...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    TaggedLocationViewController *taggedLocationViewController = (TaggedLocationViewController *)navigationController.topViewController;
    
    currentLocationViewController.managedObjectContext = self.persistentContainer.viewContext;
    taggedLocationViewController.managedObjectContext = self.persistentContainer.viewContext;
